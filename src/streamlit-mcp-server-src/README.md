...
![MCP Integration Demo](docs/demo_integration.gif)

*MCP統合システムのプレビュー - より詳しく見るには下のボタンをクリック*

[![MCP Integration Demo](https://img.shields.io/badge/🎬-デモ動画を見る-blue?style=for-the-badge&logo=youtube)](docs/demo_integration.mp4)

*音楽・レストラン検索統合システムのデモンストレーションです。* -->
